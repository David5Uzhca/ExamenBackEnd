...
a persistence unit "recargaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "recarga/pom.xml":
...
artifact ("recarga.war") is already built. You can build
